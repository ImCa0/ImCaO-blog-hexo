...
categories:
  - 算法刷题
cover: source@/_posts/algorithm/DFS/islands.jpg
...
![islands](source@/_posts/algorithm/DFS/islands.jpg)
...
![neighbor](source@/_posts/algorithm/DFS/neighbor.jpg)

其次，网格 DFS 中的 base case 是什么？从二叉树的 base case 对应过来，应该是网格中不需要继续遍历、`grid[r][c]` 会出现数组下标越界异常的格子，也就是那些超出网格范围的格子。

![OutOfBounds](source@/_posts/algorithm/DFS/OutOfBounds.jpg)
...
![InfiniteLoop](source@/_posts/algorithm/DFS/InfiniteLoop.gif)
...
![sign](source@/_posts/algorithm/DFS/sign.gif)
...
![MakingALargeIsland1](source@/_posts/algorithm/DFS/MakingALargeIsland1.jpg)

然而，这种做法可能遇到一个问题。如下图中红色方框内的海洋格子，它的上边、左边都与岛屿相邻，这时候连接成的岛屿面积难道是 7 + 1 + 7？显然不是。这两个 7 来自同一个岛屿，所以填海造陆之后得到的岛屿面积应该只有 7 + 1 = 8。

![MakingALargeIsland2](source@/_posts/algorithm/DFS/MakingALargeIsland2.jpg)
...
![MakingALargeIsland3](source@/_posts/algorithm/DFS/MakingALargeIsland3.jpg)
...
> ![IslandPerimeter1](source@/_posts/algorithm/DFS/IslandPerimeter1.jpg)
...
![IslandPerimeter2](source@/_posts/algorithm/DFS/IslandPerimeter2.jpg)
