...
categories:
  - 我的开发
cover: source@/assets/covers/vue-spring.jpg
---
...
![5](source@/_posts/development/FirstVueSpringboot/5.jpg)

![6](source@/_posts/development/FirstVueSpringboot/6.jpg)
...
![1](source@/_posts/development/FirstVueSpringboot/1.jpg)

### 数据

前端数据不再直接死板，从后端接收的数据以变量的形式储存下来，必要时还能进行修改，像后端发送的数据也不局限于表单内容，可以通过前端定义的变量自由定义提交的数据结构。

![2](source@/_posts/development/FirstVueSpringboot/2.jpg)
...
![3](source@/_posts/development/FirstVueSpringboot/3.jpg)

### 实体类

原本的实力类只有对应数据库的 POJO(Plain Ordinary Java Object) 现在还要加入与前端通信用的 Vo，定义了数据交换的结构。

![4](source@/_posts/development/FirstVueSpringboot/4.jpg)
...
![7](source@/_posts/development/FirstVueSpringboot/7.jpg)
